...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<ErrorResponse> handleDuplicateUser(BusinessException e) {
    ...
    protected ResponseEntity<ErrorResponse> handlerAuthorizationException(InvalidAuthorizationException e) {
        log.error("InvalidAuthorizationException", e);
        List<String> errorMessages = List.of(e.getMessage());
        HttpStatus httpStatus = HttpStatus.valueOf(e.getStatus());
        ErrorResponse errorResponse = ErrorResponse.of(httpStatus, errorMessages);
        return ResponseEntity.status(httpStatus).body(errorResponse);
    ...
    /**
     * 엔티티에 대해 고의로 접근하지 못하게 할 때.
     */
    @ExceptionHandler(EntityNotFoundException.class)
    protected ResponseEntity<ErrorResponse> handlerAuthorizationException(EntityNotFoundException e) {
